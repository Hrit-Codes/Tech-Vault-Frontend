    ...
    return(
        <div className="w-full h-full">
            ...
            <div className="flex flex-col gap-1">
                ...
                <p className="text-sm text-primary-500 dark:text-primary-300">Sign in to your account</p>
            </div>
            ...
            <form className="flex flex-col gap-4 mt-5">
                ...
                <div className="flex flex-col gap-2">
                    <label htmlFor="fullname" className="text-sm font-semibold text-primary-700 dark:text-primary-200">
                    Full Name
                    </label>
                    <input
                    id="fullname"
            ...
            <div className="flex flex-col gap-2">
                ...
                className="w-full px-4 py-3 rounded-xl border border-primary-300 dark:border-primary-700 bg-transparent text-sm text-primary-900 dark:text-white placeholder:text-primary-400 dark:placeholder:text-primary-500 outline-none focus:ring-2 focus:ring-secondary-400 dark:focus:ring-primary-400 transition"
                />
            </div>
            ...
            <div className="flex flex-col gap-2">
                ...
                <input
                    ...
                    placeholder="••••••••"
                    className="w-full px-4 py-3 rounded-xl border border-primary-300 dark:border-primary-700 bg-transparent text-sm text-primary-900 dark:text-white placeholder:text-primary-400 dark:placeholder:text-primary-500 outline-none focus:ring-2 focus:ring-secondary-400 dark:focus:ring-primary-400 transition pr-11"
                />
                <button
                    type="button"
            ...
            {/* Footer */}
            <p className="text-center text-sm my-2 text-primary-500 dark:text-primary-300">
            Already have an account?{" "}
            <Link to="/login" className="font-semibold text-secondary-500 hover:text-secondary-400 transition-colors hover:underline">
                Login In
            </Link>
            </p>
        </div>
