      ...
      <div className="w-full max-w-2xl mx-auto flex flex-col gap-6 items-center text-center">
        ...
        <div className="flex flex-row items-center gap-3 w-full max-w-md">
          <input
            ...
            className="flex-1 px-5 py-3 rounded-full border-2 border-primary-300 dark:border-primary-700 bg-transparent text-sm font-medium outline-none focus:ring-2 focus:ring-secondary-400 dark:focus:ring-primary-400 transition hover:cursor-pointer"
          />
